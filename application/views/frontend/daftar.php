     ...
     <div class="row">
       <div class="reg-wrapper">
         <div class="reg-inner space-inner">
           ...
           <h2 class="header-title font-22 text-center m-b-35">Daftar</h2>
...
<?php echo $captcha; ?>
             <div class="form-group">
               <button type="submit"  class="btn btn-lg btn-primary btn-block" >  <i class="icon-lock "></i>   Register</button>
             </div>
