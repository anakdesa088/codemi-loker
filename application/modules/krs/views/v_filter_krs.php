   ...
   <div class="col-md-12">
     <div class="white-box">
       ...
       <div class="row">
        ...
        <div class="col-md-2">
         <div class="btn-group">
            <button type="button" class="btn btn-info" data-toggle="dropdown"  aria-expanded="false">Pilih Kelas <span class="caret"></span></button>
            <ul class="dropdown-menu" role="menu">
              <li><a href="<?php echo site_url('krs'); ?>">Lihat Semua Kelas</a></li>
