...
class Model_users extends CI_Model
{
	...
	public function m_cek_id_user($id){
	...
	public function m_cek_id_dosen($id){
	...
	public function getDosenData($userId = null) 
	{
		if($userId) {
	...
	public function edit_dosen($data = array(), $id = null)
	{
	...
	public function getUserDataid($id = null)
	{
		if($id) {
