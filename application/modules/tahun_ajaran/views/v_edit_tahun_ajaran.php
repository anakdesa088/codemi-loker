  <!--Start Page Title-->
                     ...
                     <div class="row">
                         <div class="col-md-12">
                           <div class="white-box">
                             <h2 class="header-title">EDIT TAHUN AJARAN</h2>

                                <form method="post" class="form-horizontal" action="<?php echo site_url('tahun_ajaran/proses_edit_tahun_ajaran/'.$tampil->id_tahun_ajaran); ?>">

                                  <div class="form-group">
                                    <label class="col-md-2 control-label">Nama Tahun Ajaran</label>
                                    <div class="col-md-10">
                                      <input class="form-control" value="<?php echo $tampil->tahun_ajarancol; ?>" name="tahun_ajarancol" type="text">
                                    </div>
                                  </div>
                                  <div class="form-group">
