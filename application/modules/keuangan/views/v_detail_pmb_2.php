   ...
   <div class="page-title-box">
    <h4 class="page-title">DETAIL PMB</h4>
    <ol class="breadcrumb">
        <li>
            <a href="#">AKADEMIK</a>
        </li>
           ...
           <div class="col-md-3">
               <div class="profile-box white-box">
                   ...
                   <div class="profile-thumb">
                    ...
                    <?php
                    if ($tampil->foto_diri == false) {
                     ?>
                     <img src="<?php echo base_url('assets/images/pmb.png'); ?>" alt="profile" />
...
<div class="col-md-8 col-lg-9 m-b-40">
    <div class="m-b-10">
        <ul class="nav nav-tabs navtab-custom">
            ...
            <li class="">
                <a href="#data_berkas" data-toggle="tab" aria-expanded="false">
                    <span class="visible-xs"><i class="fa fa-cog"></i></span>
                    <span class="hidden-xs">DATA BERKAS</span>
                </a>
            </li>
        </ul>
        ...
        <div class="tab-pane" id="data_berkas">
            <form>
               <div class="form-group">
                <label>FOTO PMB :</label><br>
                <?php
                if ($tampil->foto_diri == false) {
                    echo "Foto belum di upload";
                }else{
                    ?><img width="300" src="<?php echo base_url('uploads/'.$tampil->foto_diri); ?>">
                    <?php
                } ?>
            </div>
            <div class="form-group">
                ...
                <?php 
                if ($tampil->foto_ijazah == false) {
                    echo "Foto belum di upload";
                }else{
                    ?>
                    <img width="300" src="<?php echo base_url('uploads/'.$tampil->foto_ijazah); ?>">
                    <?php
                }
            ...
            <div class="form-group">
                <label>FOTO BUKTI KESEHATAN :</label><br>
                <?php 
                if ($tampil->foto_bukti_pembayaran == false) {
                    echo "Foto belum di upload";
                }else{
                    ?>
                    <img width="300" src="<?php echo base_url('uploads/'.$tampil->foto_bukti_pembayaran); ?>">
                    <?php
                }
